...
import { BarChart3, BookOpenCheck, Compass, FileText, History, LayoutDashboard, LogOut, Settings2, ShieldCheck, Target, Waypoints } from "lucide-react";
...
const navigation = [
  ...
  { href: "/app/transiciones", label: "Transición a auditoría", icon: Waypoints },
  { href: "/app/guia", label: "Guía y recorrido", icon: BookOpenCheck },
